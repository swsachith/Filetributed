...
public class JoinNode {
  ...
  public interface AsyncIface {
    ...
    public void joinRequest(String ipAddress, int port, int clusterID, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.joinRequest_call> resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String recv_joinRequest() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void joinRequest(String ipAddress, int port, int clusterID, org.apache.thrift.async.AsyncMethodCallback<joinRequest_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class joinRequest_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public joinRequest_call(String ipAddress, int port, int clusterID, org.apache.thrift.async.AsyncMethodCallback<joinRequest_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
  ...
  public static class joinRequest_args implements org.apache.thrift.TBase<joinRequest_args, joinRequest_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(joinRequest_args other) {
      ...
      joinRequest_args typedOther = (joinRequest_args)other;
  ...
  public static class joinRequest_result implements org.apache.thrift.TBase<joinRequest_result, joinRequest_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public joinRequest_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    public int compareTo(joinRequest_result other) {
      ...
      int lastComparison = 0;
      joinRequest_result typedOther = (joinRequest_result)other;
