...
public class iptable implements org.apache.thrift.TBase<iptable, iptable._Fields>, java.io.Serializable, Cloneable, Comparable<iptable> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("iptable");
  ...
  static {
    schemes.put(StandardScheme.class, new iptableStandardSchemeFactory());
    schemes.put(TupleScheme.class, new iptableTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(iptable.class, metaDataMap);
  }
  ...
  public iptable deepCopy() {
    return new iptable(this);
  }
  ...
  public iptable setMyIP(String myIP) {
    this.myIP = myIP;
    return this;
  }
  ...
  public iptable setMyPort(int myPort) {
    this.myPort = myPort;
    setMyPortIsSet(true);
    return this;
  }
  ...
  public iptable setMyClusterID(int myClusterID) {
    this.myClusterID = myClusterID;
    setMyClusterIDIsSet(true);
    return this;
  }
  ...
  public iptable setEntries(String entries) {
    this.entries = entries;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof iptable)
      return this.equals((iptable)that);
    return false;
  }

  public boolean equals(iptable that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(iptable other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("iptable(");
    boolean first = true;
  ...
  private static class iptableStandardSchemeFactory implements SchemeFactory {
    public iptableStandardScheme getScheme() {
      return new iptableStandardScheme();
    }
  }

  private static class iptableStandardScheme extends StandardScheme<iptable> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, iptable struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, iptable struct) throws TException {
      struct.validate();
  ...
  private static class iptableTupleSchemeFactory implements SchemeFactory {
    public iptableTupleScheme getScheme() {
      return new iptableTupleScheme();
    }
  }

  private static class iptableTupleScheme extends TupleScheme<iptable> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, iptable struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, iptable struct) throws TException {
